...
例如：
![视图重写1](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写1.png)
...
![视图重写2](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写2.png)

## 二、对于MySql来说如何使用视图重写优化视图？

基于优化准则，我们通过几个实例开看下优化是如何达到的。
  ![视图重写3](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写3.png)
  
1）在简单视图上执行连接操作

直接用视图和表做连接操作，查询执行计划如下：

 ![视图重写4](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写4.png)
 ![视图重写5](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写5.png)
这里我们可以看到，视图在被优化后，视图消失了，并且成为了基表的一部分子查询。

然后，我们对比下，在表上执行与简单视图等价的连接操作：
 ![视图重写6](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写6.png)
 ![视图重写7](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写7.png)
...
基于表t1和t2的视图v_t_1_2，进行聚集操作：
 ![视图重写8](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写8.png)
 ![视图重写9](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写9.png)
 
这里子查询没有被消除，但是视图转化为了子查询，优化完成。

3）直接用视图和表做连接操作，并执行分组操作
 ![视图重写10](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写10.png)
 ![视图重写11](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写11.png)
 
视图消失，转化为基于基表的子查询。

4）直接用视图和表做连接操作，并执行分组和去重操作操作
 ![视图重写12](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写12.png)
 ![视图重写13](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写13.png)
 
视图消失，转化为基于基表的子查询。

5）在简单视图上执行外连接操作
 ![视图重写14](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写14.png)
 ![视图重写15](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写15.png)
 
视图消失，转化为基于基表的子查询。

6）直接用复杂视图和表做连接操作
 ![视图重写16](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写16.png)
 ![视图重写17](https://github.com/ftvbftvbq/ftvbftvbq.github.io/blob/master/images/视图重写17.png)
